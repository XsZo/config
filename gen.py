...
src = requests.get(
    'https://cdn.jsdelivr.net/gh/KOP-XIAO/QuantumultX@master/Scripts/resource-parser.js').text
with open('quantumult/parser.js', 'tw') as file:
    file.write(src)

# AdGuard DNS Filter

src = requests.get(
    'https://filters.adtidy.org/ios/filters/15.txt').text
with open('src/filter/adguard.txt', 'tw') as file:
    file.write(src)
